...
import { Briefcase, Users, UserRoundCog, UserCircle, Building2, FileText, Bookmark, ScrollText, Send, Search, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    const fetchAppliedJobs = async () => {
        try {
            const res = await axios.get('/api/candidate/applications', {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('precisedTalentToken')}`,
                },
            });
