        ...
        <div className="mx-auto bg-white rounded-xl shadow border p-6 mb-4">
            ...
            <div className="mt-4">
                ...
                <ul className=" list-inside text-sm">
                    {job.responsibilities ? job.responsibilities.map((item, idx) => (
            ...
            <div className="mt-4">
                ...
                <ul className="list-inside text-sm">
                    {job.benefits ? job.benefits.split(',').map((benefit, idx) => (
                        <li key={idx} className='mb-5'>
                            <svg className='inline mr-2' height="12" viewBox="384 349 257 512" width="12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <path d="M640,604.16L384,860.16L384,348.16Z" fill="#0270ad" fill-opacity="1">
                                </path>
...
const JobDetailsPage = () => {
    ...
    const { id } = useParams(); // gets '1' from the URL
        ...
        <div className="animate-fade-in ">
            ...
            <section className="section-padding bg-gray-100/70">
                <div className="container-custom">
                    ...
                    <JobDetailsCard
                        jobSalary={jobData1.salary_range || "Not Disclosed"}
                        delay='0.3'
                        jobTitle={jobData1.title || "N/A"}
                        jobLocation={jobData1.location || "N/A"}
                        companyName={jobData1.company_name || "Company"}
                        companyRating={jobData1.company_ratings || 0}
                        companyLogo={jobData1.company_logo || null}
                        jobExperience={jobData1.experience_required || "N/A"}
                        setModalType={setModalType}
                        setModalOpen={setModalOpen}
                        handleResumeUpload

                    />
                    <JobDescription job={jobData1} />
